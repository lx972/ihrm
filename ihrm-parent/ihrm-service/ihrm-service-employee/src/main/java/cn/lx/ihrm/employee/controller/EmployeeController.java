package cn.lx.ihrm.employee.controller;

import cn.lx.ihrm.common.controller.BaseController;
import cn.lx.ihrm.common.domain.employee.*;
...
import cn.lx.ihrm.common.utils.BeanMapUtils;
import cn.lx.ihrm.employee.service.*;
...
public class EmployeeController extends BaseController {
    ...
    public Result savePersonalInfo(@PathVariable(name = "id") String uid, @RequestBody Map map) throws Exception {
        ...
        sourceInfo.setCompanyId(super.getCompanyId());
